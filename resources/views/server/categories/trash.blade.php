    ...
    <div class="col-12 col-sm-12">
        <div class="card product-sales-main">
            <div class="card-header border-bottom d-flex justify-content-between align-items-center">
                <div>
                    <a href="{{route('categories.index')}}" class="btn btn-primary me-2">Trở Lại </a>
                </div>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table id="data-table" class="table text-nowrap mb-0 table-bordered">
                        <thead class="table-head" id="listCategories">
                            <tr>
                                <th>STT</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-stretch">
                                        ...
                                        <!--Delete-->
                                        <a data-name="{{ $categories->name }}"
                                            class="btn btn-sm btn-outline-secondary border me-2 delete-link"
                                            data-bs-toggle="tooltip"
                                            data-route="{{ route('categories.delete', ['id' => $categories->id]) }}"
