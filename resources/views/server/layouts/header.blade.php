    ...
    <div class="container-fluid main-container">
        <div class="d-flex">
            ...
            <a class="logo-horizontal " href="">
                ...
                <img src="{{ asset('admin_template/assets/images/brand/logo-3.png')}}"
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent-4">
                        <div class="d-flex order-lg-2">
                            ...
                            <div class="dropdown  d-flex shopping-cart">
                                <a href="" class="nav-link icon text-center" data-bs-toggle="dropdown"
                                    aria-expanded="false">
                                    <svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24"
                                        viewBox="0 0 24 24">
                                        <path
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="ms-auto">
                                                <span
                                                    ...
                                                    <a href="" class="showall-text text-white">Remove
                                                        All</a>
                                                </span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="header-dropdown-list cart-menu ps4 overflow-hidden">
                                        <a class="dropdown-item d-flex p-4" href="">
                                            <span class="avatar avatar-lg br-5 me-3 align-self-center cover-image"
                                                data-bs-image-src="{{ asset('assets/images/ecommerce/1.jpg')}}"></span>
                                            <div class="wp-60 cart-desc mt-1">
                                                <p class="fs-13 mb-0 lh-1 mb-1 text-dark fw-500">TrueBasket
                                                    Metal Single Pot</p>
                                                <p class="fs-12 fw-300 lh-1 mb-0">Status: <span class="text-green">In
                                                        Stock</span></p>
                                        ...
                                        <a class="dropdown-item d-flex p-4" href="">
                                            <span class="avatar avatar-lg br-5 me-3 align-self-center cover-image"
                                                data-bs-image-src="{{ asset('assets/images/ecommerce/2.jpg')}}"></span>
                                            <div class="wp-60 cart-desc mt-1">
                                        ...
                                        <a class="dropdown-item d-flex p-4" href="">
                                            <span class="avatar avatar-lg br-5 me-3 align-self-center cover-image"
                                                data-bs-image-src="{{ asset('assets/images/ecommerce/3.jpg')}}"></span>
                                            <div class="wp-60 cart-desc mt-1">
                                        ...
                                        <a class="dropdown-item d-flex p-4" href="">
                                            <span class="avatar avatar-lg br-5 me-3 align-self-center cover-image"
                                                data-bs-image-src="{{ asset('assets/images/ecommerce/4.jpg')}}"></span>
                                            <div class="wp-60 cart-desc mt-1">
                                                <p class="fs-13 mb-0 lh-1 mb-1 text-dark fw-500">Branded
                                                    Head Phones</p>
                                                <p class="fs-12 fw-300 lh-1 mb-0">Status: <span class="text-danger">No
                                                        Stock</span></p>
                                                <span class="fs-12 fw-300 lh-1 mb-0">Quantity: 01</span>
                                            </div>
                                            <div class="ms-auto text-end d-flex fs-16">
                                        ...
                                        <a class="dropdown-item d-flex p-4" href="">
                                            <span class="avatar avatar-lg br-5 me-3 align-self-center cover-image"
                                                data-bs-image-src="{{ asset('assets/images/ecommerce/5.jpg')}}"></span>
                                            <div class="wp-60 cart-desc mt-1">
                            ...
                            <div class="dropdown d-md-flex profile-1">
                                <a href="#" data-bs-toggle="dropdown" class="nav-link pe-2 leading-none d-flex animate">
                                    <span>
                                        ...
                                        <img src="{{ asset($imagePath) }}" alt="profile-user"
                                            class="avatar profile-user brround cover-image">
                                    </span>
                                    <div class="text-center p-1 d-flex d-lg-none-max">
                                        <h6 class="mb-0" id="profile-heading">{{ $user->fullname }}<i
